...
export default function WhatsAppButton() {
    ...
    return (
        ...
        >
            ...
            {/* Hover Tooltip */}
            <span className="absolute right-full mr-3 px-3 py-1.5 rounded-md bg-slate-900 border border-slate-800 text-slate-200 text-xs font-semibold tracking-wide whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none shadow-md">
                Bengal-IT
            </span>
        </button>
    );
